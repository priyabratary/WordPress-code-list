   ...
   <div class="col-xs-12 col-sm-2 col-lg-2">
                          ...
                          <div class="col-xs-12 col-sm-5 col-lg-4">
                            	<div class="contact-detail-box">
                                	<p><i class="fa fa-envelope-o"></i> <a href="mailto:info@veecode.com">info@veecode.com</a></p>
                                    <p><i class="fa fa-phone"></i> <strong>+1-567-258-2548</strong></p>
                                    <p><i class="pull-left fa fa-map-marker"></i> 171 Minglehaze Drive, Toronto, Ontario,
                                  M9V 4W7, Canada</p>
                              </div>
                          </div>
